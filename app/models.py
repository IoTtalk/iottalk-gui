...
def define_legacy_entities(db):
	...
	'''
        ...
        feature = pony.Required(DevFeature, column='dfo_id')
    ...
    class DfParameter(db.Entity):
        ...
        df_id = pony.ForeignKey('DevFeature', pony.DO_NOTHING, blank=True, null=True)
    ...
    class Simulatedidf(db.Entity):
        ...
        df_id = pony.ForeignKey(DevFeature, pony.DO_NOTHING, primary_key=True)
